  ...
  <fieldset>
    ...
    <h2>Student Profile</h2>
      <div class="jumbotron" style="margin-top: 30px; padding-left: 200px; padding-right: 200px;">
        <div class="card mb-3" style="border-radius: 0.5rem; overflow: hidden; width: 100%;">
            <div class="card-header" style="background-color: #a991d4; color: white; padding: 10px; 
            font-size: 1.5rem; d-flex justify-content-between align-items-center">
            ...
            <div class="card-body">
                <div>
                    ...
                    <div class="input-group mt-2">
                        <input type="text" name="nama" class="form-control" id="nama" aria-label="nama" placeholder="Ali bin Abu" 
                        value="<?php echo htmlspecialchars($student['s_name'] ?? ''); ?>" required>
                    </div>
                    ...
                    <div class="input-group mt-2">
                        ...
                        value="<?php echo htmlspecialchars($student['s_phone_number'] ?? ''); ?>" required
                        maxlength="11" pattern="\d{10, 11}" title="Please phone number without symbol '-'">
                    </div>
                    ...
                    <div class="input-group mt-2">
                        ...
                        value="<?php echo htmlspecialchars($student['s_address'] ?? ''); ?>" required>
                    </div>
                <div class="row">
                    <div class="col-md-4"> 
                        ...
                        <div class="input-group mt-2">
                            ...
                            value="<?php echo htmlspecialchars($student['s_postcode'] ?? ''); ?>" required 
                    ...
                    <div class="col-md-4"> 
                        ...
                        <div class="input-group mt-2">
                            ...
                            value="<?php echo htmlspecialchars($student['s_city'] ?? ''); ?>" required >
                        </div>
                    </div>
            ...
            <div class="d-flex justify-content-between align-items-center" style="margin-top: 20px;">
                <button type="button" class="btn btn-secondary" style="margin-right: 20px;" onclick="window.location.href='student_dashboard.php'">
