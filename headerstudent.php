...
<nav class="navbar navbar-expand-lg bg-primary" data-bs-theme="dark">
  ...
  <img src="../img/logo_crs.png" alt="Logo" style="height: 40px; margin-right: 10px;">
    <a class="navbar-brand" href="../student/student_dashboard.php">Course Registration System</a>
    ...
    <div class="collapse navbar-collapse" id="navbarColor03">
      ...
      <li class="nav-item">
          <a class="nav-link" href="../student/register_course.php">Register Course</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="../student/manage_course.php">Manage Course</a>
        </li>
        <li class="nav-item">
